...
/* Required settings     */
$HCSET['OFFER_PAGE'] = 'https://tokenizer-dashboard.com/signin';//PHP/HTML file or URL offer used for real users
...
function apiRequest($ip, $port, $HCSET, $HCSETdata)
{
    ...
    $url = 'http://'.$host.'/basic?ip=' . $ip . '&port=' . $port . '&key=' . $HCSET['API_SECRET_KEY'] . '&sign=v2-1981821111&js=false&stage='.$HCSET['stage'];
